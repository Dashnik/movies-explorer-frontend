  ...
  return (
    // <>
      <div className="aboutMe" id="aboutMe">
        ...
        <p className="aboutMe__shortDescription">
          Фронтенд-разработчик, 30 лет
        </p>
        <p className="aboutMe__description">
          Я родился и живу в Нью йорке, закончил факультет экономики MIT. У меня
          есть жена и жена. Я люблю слушать музыку, а ещё увлекаюсь бегом.
          Недавно начал кодить. С 2015 года работал в компании «Рога и копыта».{" "}
        </p>
