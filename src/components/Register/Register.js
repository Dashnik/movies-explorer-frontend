          ...
          {({
            ...
            <form className="register__form">
              ...
              {touched.email && errors.email && (
                <p className="register__error register__error-email">
                  {errors.email}
                </p>
              )}
              ...
              {touched.password && errors.password && (
                <p className="register__error register__error-password">
                  {errors.password}
                </p>
              )}
              { (props.regError ?  <p className="register__error-answer">Что-то пошло не так! Попробуйте ещё раз.</p> : ''
              )}
              <button
                type="submit"
                className={`register__submit ${
                  isValid && dirty ? "" : "register__submit-disabled"
                }`}
